...
VelocityControl::VelocityControl(int encoderPinA, int encoderPinB, int motorPWMPin, int motorIn1Pin, int motorIn2Pin, float _kp)
    : encoder(encoderPinA, encoderPinB), motor(motorPWMPin, motorIn1Pin, motorIn2Pin), kp(_kp), setpoint(0), previousError(0), integral(0), ki(0), kd(0), kf(0), lastCount(0), lastTimestamp(0), bufferIndex(0) 
{
